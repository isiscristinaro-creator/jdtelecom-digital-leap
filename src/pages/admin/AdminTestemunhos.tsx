...
const AdminTestemunhos = () => {
  ...
  const [form, setForm] = useState({ nome: "", mensagem: "", ativo: true });

  const openCreate = () => { setForm({ nome: "", mensagem: "", ativo: true }); setIsCreating(true); setEditing(null); };
  const openEdit = (t: DbTestemunho) => { setForm({ nome: t.nome, mensagem: t.mensagem, ativo: t.ativo }); setEditing(t); setIsCreating(false); };
